...
public class Fall2023Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        gameRunner.addAgent("python " + agent1 + " " + weight1, "Agent_1");
        gameRunner.addAgent("python " + agent2 + " " + weight2, "Agent_2");
        ...
        writer.write(String.valueOf(gameResult.scores.get(0)));
        writer.write("\n");
        writer.write(String.valueOf(gameResult.scores.get(1)));
        writer.write("\n");
        writer.close();
    }
