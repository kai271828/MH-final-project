...
class NeuralNetwork:
    ...
    def load(self, filename):
        ...
        self.w_1 = weights[offset:offset + size].reshape((self.hidden_size, self.input_size))
        offset += size
        ...
        self.w_2 = weights[offset:offset + size].reshape((self.output_size, self.hidden_size))
        offset += size
    ...
    def save(self, filename):
        ...
        np.savetxt(filename, np.concatenate((self.w_1.flatten(), self.b_1.flatten(), self.w_2.flatten(), self.b_2.flatten())))
